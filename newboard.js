let newBoard = [
    ...
    { key: 29, boardNumber: 33, name: 'X', deleteItem: 'D3', extraScore: 1 }, 
    ...
    { key: 35, boardNumber: 5, name: 'X', extraScore: 1 },
    { key: 36, boardNumber: 32, name: 'D', itemsToAdd: 'D3' }, 
    { key: 37, boardNumber: 1, name: 'X', invisible: true, extraScore: 1, addItem: 'D3', aboutText: 'on the board which will cause you to miss a' }, 
    ...
    { key: 78, boardNumber: 26, name: 'X', extraScore: 1 }, 
    ...
    { key: 98, boardNumber: 14, name: 'X', extraScore: 1 },
    ...
    { key:103, boardNumber: 1, name: 'X', invisible: true, extraScore: 1, addItem: 'D2' }, 
    { key:104, name: '', invisible: true }, 
    { key:105, boardNumber: 15, name: '' },
    { key:106, boardNumber: 22, name: 'O', extraScore: -1 }, 
    { key:107, boardNumber: 21, name: '' }, 
    { key:108, boardNumber: 20, name: '' }, 
    { key:109, boardNumber: 19, name: 'X', deleteItem: 'D2', extraScore: 1 },
    { key:110, boardNumber: 18, name: 'D', itemsToAdd: 'D2' }, 
    { key:111, boardNumber: 17, name: '' }, 
    { key:112, boardNumber: 16, name: 'O', extraScore: -1 },
  ];
