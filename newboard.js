let newBoard = [
    ...
    { key: 37, boardNumber: 1, name: 'X', invisible: true, extraScore: 1, addItem: 'D3', aboutText: 'on the board which will increase or decrease' }, 
    ...
    { key: 44, name: '', invisible: true, aboutText: 'the Score number by one simulating you either'   }, 
    ...
    { key: 51, name: '', invisible: true, aboutText: 'missing a turn or are getting an extra roll. There' }, 
    ...
    { key: 58, name: '', invisible: true, aboutText: 'are spots on the board which will change the ' }, 
    ...
    { key: 65, name: '', invisible: true, aboutText: 'shape of the board making the distance to travel' }, 
    ...
    { key: 72, name: '', invisible: true, aboutText: 'longer.' }, 
